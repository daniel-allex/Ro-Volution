repeat wait() until script.Parent.Parent.Parent.Parent.Name ~= "Bot"
local character = script.Parent.Parent.Parent

local names = {"Flamingo", "Bot2", "Bot3", "Bot4"}
local playerName = names[math.random(#names)]
...
local evoLvl = script.Parent.Parent.Parent.Values.evoLvl
